...
@if ($modal)
		@include('livewire.admin.create-industries')
@endif
																		...
																		<tr class="border-b border-gray-200 hover:bg-gray-100">
																				...
																				<td class="py-3 px-6 text-center">
																						<div class="flex items-center justify-center">
																								<img class="h-12 w-auto rounded"
																										src="{{ Storage::url($industry->photo) }}" />
																						</div>
																				</td>
																				<td class="py-3 px-6 text-center">
																						<div class="flex item-center justify-center">
																								<button wire:click="edit({{ $industry->id }})"
																								...
																								<button wire:click="openDeleteModal({{ $industry->id }})" class="p-3 mx-1 transform hover:text-purple-500 hover:scale-110 rounded-full hover:bg-slate-200">
																										<svg width="24px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
																												stroke="currentColor">
																												<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
